...
#declare BM_PoseNo=6;  // If Pose_Studio is set to "no" set this to 
                       // a Pose Number from the list above.

/****************************************************************
 General Settings used for Pose Studio and Pre-Defined Poses
*****************************************************************/
#declare BM_Gender    = 0;             // Male=0, Female=1
...
//#declare Costume      = "jc.cdf"		// Name of Costume Definition File eg. "sample.cdf"
...
#declare BM_Neck_Rot = <0,0,0>;   // Rotation vector for the neck (Note: "y" is not used)
#declare BM_Torso_Rot= <0,0,0>;   // Rotation vector for the Upper Torso 

#declare BM_RA_S2E   = <0,0,0>;  // Right Upperarm
#declare BM_RA_E2W   = <0,0,0>;  // Right Forearm
#declare BM_RH_Rot   = <0,0,0>;  // Right Hand

#declare BM_LA_S2E   = <0,0,0>;  // Left Upperarm
#declare BM_LA_E2W   = <0,0,0>;  // Left Forearm
#declare BM_LH_Rot   = <0,0,0>;  // Left Hand

#declare BM_RL_H2K   = <0,0,0>;  // Right Thigh
#declare BM_RL_K2A   = <0,0,0>;  // Right Lower Leg
#declare BM_RF_Rot   = <0,0,0>;  // Right Foot

#declare BM_LL_H2K   = <0,0,0>;  // Left Thigh
...
#declare BM_Toe_Angle  =<0,0,0>;  // x = Left Foot
                                  // y = ** Not Used **
                                  // z = Right Foot
...
#declare BM_Hair_Curl  = 0.06;       // Curliness (Range 0-Straight to 0.1-Curly) - Standard: 0.05
...
object {BlobMan scale 1.7 rotate y* 90 translate <-45,0,> no_shadow}
object {BlobMan scale 1.7 rotate x*-90 translate <40,-60,> no_shadow}
text { 
   ttf
   "crystal.ttf",
   #if (BM_Gender=0)
